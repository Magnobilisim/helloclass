    ...
    if (showSettings) {
        ...
        return (
            <div className="h-full flex flex-col bg-slate-50">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-24 max-w-5xl mx-auto w-full">
    ...
    if (activeConversation) {
        ...
        return (
            <div className="h-full flex flex-col bg-slate-50 pb-20">
                ...
                <div className="p-3 bg-white border-t border-slate-100 flex gap-2 sticky bottom-0 pb-safe-bottom max-w-5xl mx-auto w-full">
                    <input 
                        value={replyText}
    ...
    if (!hasStarted) {
        return (
            <div className="h-full flex flex-col bg-slate-50">
                 ...
                 <div className="flex-1 p-6 flex flex-col items-center justify-center text-center space-y-6 max-w-lg mx-auto w-full">
    ...
    if (showResult) {
        return (
            <div className="h-full flex flex-col bg-white items-center justify-center p-8 text-center space-y-6">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl w-full max-w-md border border-slate-100">
                ...
                <button onClick={() => { onComplete(score); onBack(); }} className="w-full max-w-md bg-slate-900 text-white py-4 rounded-2xl font-bold shadow-lg hover:scale-105 transition-transform">
                    Tamamla
                </button>
            </div>
        );
    ...
    return (
        <div className="h-full bg-white flex flex-col relative overflow-hidden">
            ...
            {!quizConfig && !viewingUserId && !showNotifications && (
                <div className="bg-white border-t border-slate-100 px-6 py-4 flex justify-between items-center absolute bottom-0 w-full pb-8 md:pb-4 z-20">
