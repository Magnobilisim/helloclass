            ...
            <section className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 mt-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div className="flex-1">
                        ...
                        {profileUser.username ? (
                            <>
                                <div className="text-3xl font-black text-gray-900">@{profileUser.username}</div>
                            ...
                            <>
                                ...
                                <p className="text-xs text-gray-400 mt-1">{t('username_cost_hint').replace('{points}', String(usernameCost))}</p>
                            </>
                        )}
                    </div>
                    <div className="w-full md:w-auto flex flex-col gap-3">
                        {profileUser.username ? (
                            <div className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-green-50 text-green-600 font-bold text-sm border border-green-100">
                                <AtSign size={16} /> @{profileUser.username}
                            </div>
                        ) : (
                            <>
